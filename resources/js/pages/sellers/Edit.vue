    ...
    <div class="container mt-5">
        <div class="card shadow-lg">
            <div class="card-header bg-gradient-primary text-white">
                <h3 class="card-title text-center">Editar Representante</h3>
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-3">
...
export default {
    ...
    data: () => ({
        seller: { name: '', state: '', city: null, id: '' },
        citySearchString: '',
        citiesFounded: [],
        successMessage: ''
    }),
    ...
    methods: {
        async getItem() {
            try {
                const response = await axios.get(`${apiRoutes.sellers.get}/${this.$route.params.id}`);
        ...
        async submitForm() {
            try {
                ...
                if (!this.v$.seller.$invalid) {
                    ...
                    await axios.put(`${apiRoutes.sellers.update}${this.$route.params.id}`, data);
