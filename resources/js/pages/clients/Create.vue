    ...
    <div class="container mt-5">
        <div class="card shadow-lg">
            <div class="card-header bg-gradient-primary text-white">
                <h3 class="card-title text-center">Cadastrar Cliente</h3>
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-4"
...
export default {
    ...
    data: () => ({
        client: { cpf: '', name: '', birth_date: '', gender: 'M', address: '', state: '', city: null, email: '' },
        citySearchString: '',
        citiesFounded: [],
        successMessage: ''
    }),
        ...
        async submitForm() {
            try {
                ...
                if (!this.v$.client.$invalid) {
                    ...
                    await axios.post(apiRoutes.client.create, this.client);
